...
-- Covers: todos (start_date + soft-delete recycle bin), all learning tables
-- ═══════════════════════════════════════════════════════════════════════

-- ───────────────────────────────────────────────────────────────────────
-- PART 0: todos table additions (start_date + soft-delete recycle bin)
-- ───────────────────────────────────────────────────────────────────────

-- Add start_date column (when you plan to start the task)
ALTER TABLE todos ADD COLUMN IF NOT EXISTS start_date date DEFAULT NULL;

-- Add soft-delete support: deleted_at = timestamp means "in recycle bin"
ALTER TABLE todos ADD COLUMN IF NOT EXISTS deleted_at timestamptz DEFAULT NULL;

-- Index for fast recycle bin queries
...
-- ───────────────────────────────────────────────────────────────────────
-- PART 2: learning_phases  (phase definitions — DB-driven)
-- ───────────────────────────────────────────────────────────────────────
