...
const MORE_NAV = [
  { href: "/board",     label: "Board",     icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="5" height="18" rx="1.5"/><rect x="10" y="3" width="5" height="12" rx="1.5"/><rect x="17" y="3" width="5" height="15" rx="1.5"/></svg> },
  ...
  { href: "/calendar",  label: "Calendar",  icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> },
];
...
function NavLink({
  ...
  href: string; label: string; icon: React.ReactNode; pathname: string;
}) {
  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{ color: isActive ? "var(--accent)" : "var(--cc-text)" }}
      >
        {icon}
      </span>
      <span
        className="hidden lg:block text-[12px] font-medium tracking-tight truncate"
        style={{
...
export function Sidebar() {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span
              ...
              style={{ color: "var(--accent)", fontFamily: "-apple-system, SF Pro Display, sans-serif" }}
            >
              S
            </span>
          </div>
          <div className="hidden lg:block overflow-hidden">
            <h1
              ...
              style={{ color: "var(--text-primary)", fontFamily: "-apple-system, SF Pro Display, sans-serif" }}
            >
              SRN Command
            </h1>
      ...
      {/* Divider */}
      <div className="mx-3 lg:mx-4 mb-3" style={{ height: "0.5px", background: "var(--cc-tile-border)" }} />
      ...
      <nav className="flex-1 px-2 overflow-y-auto overflow-x-hidden">
        ...
        {/* More section */}
        <div className="mt-2">
          {/* Toggle button — only on expanded sidebar */}
          <button
          ...
          >
            ...
            <span className="text-[11px] font-medium" style={{ fontFamily: "-apple-system, SF Pro Display, sans-serif" }}>
              More
            </span>
            <span className="text-[9px] font-mono ml-auto" style={{ opacity: 0.45 }}>
              {MORE_NAV.length}
            </span>
          </button>

          {/* Collapsed sidebar (icon-only) — always show all items */}
      ...
      {/* Divider */}
      <div className="mx-3 lg:mx-4 mt-2 mb-2" style={{ height: "0.5px", background: "var(--cc-tile-border)" }} />
