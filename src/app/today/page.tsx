...
export default function TodayPage() {
  ...
  const QUICK_ACTIONS = [
    { href: "/focus",     label: "Start focus session", icon: "⏱", color: "#4da6ff" },
    { href: "/notes",     label: "Add a note",          icon: "📝", color: "#f5a623" },
    { href: "/streaks",   label: "View streaks",        icon: "⚡", color: "#5ecf95" },
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="liquid-glass rounded-[22px] p-5 animate-fade-in-up" style={{ animationDelay: "60ms" }}>
            <h2 className="text-sm font-medium mb-3" style={{ color: "var(--text-primary)", letterSpacing: "-0.01em" }}>
              Due today{" "}
              {todayTasks.length > 0 && (
                <span className="text-xs font-mono ml-1" style={{ color: "#f5a623" }}>({todayTasks.length})</span>
              )}
            </h2>
